...
import GlobalMethod1.GlobalMethods;
import GlobalMethod1.GlobalWait;
import jxl.Sheet;
import jxl.Workbook;
...
public class TS_20 {
	...
	public void CRe4_987_988() throws Exception {
		...
		String IECMemList_data = r1.getCell(2, 142).getContents();
		String EditIECMemList_data = r1.getCell(3, 142).getContents();
		String AlertFirstName_data = r1.getCell(4, 142).getContents();
		String AlertLastName_data = r1.getCell(5, 142).getContents();
	...
	public void CRe4_990() throws Exception {
		...
		for (int i = 2; i <= 4; i++) {
			...
			Workbook wb1 = Workbook.getWorkbook(fi1);
			Sheet r1 = wb1.getSheet("Manage_IECS1");
			String UploadFileTypeValid_data = r1.getCell(i, 146).getContents();
	...
	public void CRe4_1007() throws Exception {
		...
		for (int i = 2; i <= 6; i++) {
			...
			Workbook wb1 = Workbook.getWorkbook(fi1);
			Sheet r1 = wb1.getSheet("Manage_IECS1");
			String UploadFileTypeInvalid_data = r1.getCell(i, 148).getContents();
	...
	public void CRe4_1008() throws Exception {
		...
		for (int i = 2; i <= 5; i++) {
			...
			Workbook wb1 = Workbook.getWorkbook(fi1);
			Sheet r1 = wb1.getSheet("Manage_IECS1");
			String UploadFileTypeValid_data = r1.getCell(i, 150).getContents();
	...
	public void CRe4_1019() throws Exception {
		...
		Workbook wb1 = Workbook.getWorkbook(fi1);
		Sheet r1 = wb1.getSheet("Manage_IECS1");
		String MiddleName_data = r1.getCell(2, 154).getContents();
		String EmpDetails_data = r1.getCell(3, 154).getContents();
		String DOBDetails_data = r1.getCell(4, 154).getContents();
		String ConNum_data = r1.getCell(5, 154).getContents();
		String AlertFirstName_data = r1.getCell(6, 154).getContents();
	...
	public void CRe4_1020() throws Exception {
		...
		Workbook wb1 = Workbook.getWorkbook(fi1);
		Sheet r1 = wb1.getSheet("Manage_IECS1");
		String FirstName_data = r1.getCell(2, 156).getContents();
		String LastName_data = r1.getCell(4, 156).getContents();
		String MiddleName_data = r1.getCell(3, 156).getContents();
		String EmpDetails_data = r1.getCell(3, 156).getContents();
		String DOBDetails_data = r1.getCell(4, 156).getContents();
		String ConNum_data = r1.getCell(5, 156).getContents();
	...
	public void CRe4_1021() throws Exception {
		...
		String MiddleName_data = r1.getCell(3, 158).getContents();
		String EmpDetails_data = r1.getCell(5, 158).getContents();
		String DOBDetails_data = r1.getCell(6, 158).getContents();
		String ConNum_data = r1.getCell(7, 158).getContents();
